...
public class RegistrationDAO{
	...
	public ArrayList<Registration> getExamRegistrations(String id, Date data) throws SQLException{
		ArrayList<Registration> Regs= new ArrayList<>();
		String prep="SELECT A.Matricola,StatoValutazione,Voto,Mail,CorsoLaurea,Nome,Cognome,NomeCorso FROM iscrizioniappelli as A ,utenti as B, corsi as C WHERE A.Matricola=B.Matricola and A.CodiceCorso=? and A.CodiceCorso=C.CodiceCorso and Data=?";
